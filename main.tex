...
\begin{center}
  ...
  \small
  \faAt \hspace{.5pt} \href{mailto:anighojkar@icloud.com}{anighojkar@icloud.com}
  $|$
...
Ph.D. in Computer Science specializing in Natural Language Processing (NLP) and Machine Learning (ML), seeking a challenging role where I can apply my expertise in advanced language modeling, prompt engineering, and transformer-based language models. With 2 impactful internships at Dropbox, Inc. and 5 years of research at the University of South Florida, I have a proven track record in developing innovative ML solutions.
...
{Ph.D., Computer Science and Engineering}{Aug 2019 \textbf{--} Aug 2024}
...
{\textbf{Lyric Mimicry in the Style of Your Favorite Artist
  }}{}
\resumeItemListStart
\resumeItem{A customizable song lyric generation tool that emulates the style of selected artists or albums using popular LLMs like OpenAI GPT-4 and Anthropic Claude. The project analyzed lyrical patterns from chosen albums to create new, original lyrics tailored to specific user inputs, such as occasion, recipient, keywords, and thematic descriptions.}
\resumeItemListEnd
...
\resumeProjectHeading
{\href{https://sites.ualberta.ca/~rabelo/COLIEE2024}{\textbf{First place in the Competition on Legal Information Extraction/Entailment (COLIEE)}}}{Jan 2024}
\resumeItemListStart
\resumeItem{Got first place out of 18 submissions on the legal case entailment task, which involves the identification of a paragraph from existing cases that entails the decision of a new case.}
\resumeItemListEnd

\resumeProjectHeading
{\href{https://new.nsf.gov/funding/initiatives/i-corps}{\textbf{NSF I-Corps Regional Certificate}}}{Dec 2023}
\resumeItemListStart
\resumeItem{The mission of I-Corps is to reduce the risk associated with translating technologies from the laboratory to the marketplace. As a part of this program, conducted over 50 customer discovery interviews, leading to the development of a validated business model for regulatory compliance using AI. Developed key skills in market analysis, strategic business planning, and team collaboration.}
\resumeItemListEnd

\resumeProjectHeading
{\href{https://www.usf.edu/engineering/cse/newsroom/09092021-duolingo-award.aspx}{\textbf{Duolingo Award for Best Presentation}}}{Sep 2021}
\resumeItemListStart
\resumeItem{Won the Duolingo Award for best student presentation at the International Meeting of the Psychometric Society (IMPS 2021) for presenting the paper ``Predicting Human Psychometric Properties Using Computational Language Models.'' This award was given to only 3 presentations out of roughly 130.}
\resumeItemListEnd
